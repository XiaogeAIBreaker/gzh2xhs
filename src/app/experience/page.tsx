        ...
        <section className="relative mb-16">
          <ParallaxHero>
            <div className="relative z-10 flex flex-col items-center text-center">
              <NeonHeading title="宇宙级酷炫体验" subtitle="现代视觉 · 视差滚动 · 微交互" />
              <div className="mt-6 flex items-center gap-3">
                <button className="btn-glow rounded-lg bg-white/10 px-5 py-3 text-sm hover:bg-white/15">
                  立即体验
                </button>
                <button className="glass-card rounded-lg px-5 py-3 text-sm">了解设计</button>
              </div>
            </div>
          </ParallaxHero>
        ...
        <section>
          ...
          >
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              ...
              <button className="glass-card rounded-lg px-6 py-3 text-sm">更多示例</button>
            </div>
          </motion.div>
        </section>
      </div>
